...
class IntakeSession:
    ...
    symptom: str = ""  # optional, default empty
    ...
    def truncate_after(self, index_inclusive: int) -> None:
        """Remove all questions after the given index, reset state."""
...
class Visit:
    ...
    patient_id: str
    symptom: str
    status: str = "intake"  # intake, transcription, soap_generation, prescription_analysis, completed
    ...
    def complete_transcription(
        self, transcript: str, audio_duration: Optional[float] = None
    ) -> None:
